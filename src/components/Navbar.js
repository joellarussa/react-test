...
const Navbar = () => {
    return (
        <nav style={{ backgroundColor: '#000', padding: '1rem 4rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
                <a href="mailto:email@example.com" style={{marginRight: '1.6em', color: 'white'}}>
                ...
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" style={{marginRight: '1.6em', color: 'white'}}>
            ...
            <div>
                <a href="#projects" style={{ color: 'white', marginRight: '1rem' }}>Projects</a>
